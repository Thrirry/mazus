...
public class ProductService {
   ...
   @Bean
    ...
    private List<Product> products = new ArrayList<>(Arrays.asList(
            new Product("1", "Outerwear", "Scarves & Gloves", "Pull-on pant from NEED in Olive. High rise. Elasticized waistband with interior adjustable drawstrings. Faux fly. Two slant pockets at front. Two welt pockets at back. Tonal stitching. Relaxed fit.", "$86", "S / M / L", "scarves-gloves", "http://localhost:8080/image/hp_nc_09.jpg", "http://localhost:8080/image/hp_nc_07.jpg"),
            ...
            new Product("3", "Tees" ,"Pamela Dress", "Mock neck cardigan sweater from S.N.S. Herning in Navy Blue. Knit crisscross pattern. Mock neck collar. Full button front placket. Ribbed trim. Straight hem. Slim fit.", "$52", "S / M / L", "pamela-dress", "http://localhost:8080/image/nc_03.jpg", "http://localhost:8080/image/nc_03.jpg"),
