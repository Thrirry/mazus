...
public class CustomerService {
    ...
    private List<Customer> customers = new ArrayList<>(Arrays.asList(
            new Customer("9","mrred", "mrred@mazus.com", "asas", "27 Yen Bai", "0988972771", "female"),
            new Customer("2","mrblue", "mrblue@mazus.com", "adad", "24 Hoang Dieu", "098816262", "male"),
            new Customer("4","mrpink", "mrpink@mazus.com", "dfdf", "237 Ton Duc Thang", "098122731", "female"),
            new Customer("7","mrwhite", "mrwhite@mazus.com", "cdcd", "123 Ton That Tung", "091122133", "female"),
